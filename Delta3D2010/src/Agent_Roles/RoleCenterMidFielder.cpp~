...
#include "RoleCenterMidFielder.h"
...
void RoleCenterMidFielder::execute() 
{
...
void RoleCenterMidFielder::doKick()
{
   ...
   std::cout<<"RoleCenterMidFielder doKick execute"<<std::endl;   
};

void RoleCenterMidFielder::doMove()
{
...
void RoleCenterMidFielder::doStandUp()
{
    std::cout<<"RoleCenterMidFielder doStandup execute"<<std::endl;
...
void RoleCenterMidFielder::doStop()
{
//     BhvFocusBall().execute();
    std::cout<<"RoleCenterMidFielder doStop execute"<<std::endl;
    WorldModel& wm   = WorldModel::instance();
    Walk&       walk = Walk::instance();

    if (walk.IsPrepareDone() && wm.isStable())
    {
        cout <<"RoleCenterMidFielder::doStop : 'prepare walk done' "<<endl;
