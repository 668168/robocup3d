...
namespace bats
{
  ...
  /**
   *  Behavior: Guard the goal (not so good yet :))
   */
  class GuardGoal : public Behavior
  {

    Vector3D d_ballEndPos;
    Vector3D d_goalL, d_goalR;
    Vector3D d_ownPos;
     ...
     *  @returns confidence (0.5, 0.2) when it want to do something (0.0, 0.0) if not.
     */
