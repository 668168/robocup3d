...
namespace bats {
  ...
  public:
    ...
    */
    ...
    {
      res.setX(a.d_values[0 + 0*4] * b.d_values[0] +
               a.d_values[0 + 1*4] * b.d_values[1] +
               a.d_values[0 + 2*4] * b.d_values[2] +
               a.d_values[0 + 3*4] * b.d_values[3]);

      res.setY(a.d_values[1 + 0*4] * b.d_values[0] +
               a.d_values[1 + 1*4] * b.d_values[1] +
               a.d_values[1 + 2*4] * b.d_values[2] +
               a.d_values[1 + 3*4] * b.d_values[3]);

      res.setZ(a.d_values[2 + 0*4] * b.d_values[0] +
               a.d_values[2 + 1*4] * b.d_values[1] +
               a.d_values[2 + 2*4] * b.d_values[2] +
               a.d_values[2 + 3*4] * b.d_values[3]);

      res.setW(a.d_values[3 + 0*4] * b.d_values[0] +
               a.d_values[3 + 1*4] * b.d_values[1] +
               a.d_values[3 + 2*4] * b.d_values[2] +
      ...
      for (unsigned i = 0; i < 4; i++)
        for (unsigned j = 0; j < 4; j++)
        {
          ...
          for (unsigned k = 0; k < 4; k++)
            res.d_values[idx] += a.d_values[k + j * 4] * b.d_values[i + k * 4];
        }
    }
