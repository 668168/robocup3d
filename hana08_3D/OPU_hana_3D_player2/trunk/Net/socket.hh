...
#ifndef __SYSINC_FCNTL_H_
#define __SYSINC_FCNTL_H_
#include <fcntl.h>
#endif
...
#ifndef __SYSINC_STDEXCEPT
#define __SYSINC_STDEXCEPT
#include <stdexcept>
#endif
...
//	      std::cout << "Socket::read" << _buf << ", " << _size << " = " << res << std::endl;
    ...
    {
//	std::cout << "Socket::write  socket_handle = " << socket_handle << std::endl;
      assert(socket_handle);
...
//      std::cout << "Socket::writeExactly total="<< total << std::endl;
      return total;
    }
