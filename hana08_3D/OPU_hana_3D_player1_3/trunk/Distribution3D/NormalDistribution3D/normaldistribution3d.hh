...
namespace bats {
   ...
   */
  class NormalDistribution3D : public IDistribution3D
  {
  ...
  public:
     ...
     */
    virtual void predict(rf<IDistribution3D> const &movementModel);
     ...
     */
    virtual void update(rf<IDistribution3D> const &measurementModel);
  };
