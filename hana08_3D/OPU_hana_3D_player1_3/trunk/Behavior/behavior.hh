...
namespace bats
{
  /** Behavior class
   *
   * This is the Behavior class, the building block of the BATS agents. It supplies the basic architecture to set up a hierarchy of behaviors. A behavior can be given a goal to achieve. New behaviors should inherit from this class and implement the following methods:
   * <dl>
   *   <dt>rf<Goal> generateGoal(unsigned step, unsigned slot)</dt>
   *   <dd>This method is called to generate a subgoal for the subbehaviors in a slot. The goal is a State description tree containing nodes of type andType and varType.</dd>
