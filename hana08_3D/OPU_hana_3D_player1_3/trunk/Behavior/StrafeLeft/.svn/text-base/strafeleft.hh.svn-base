...
#ifndef _BATS_STRAFELEFT_HH_
#define _BATS_STRAFELEFT_HH_

#include "behavior.hh"

namespace bats
{
  /// Behavior: Strafe left with small precise steps
  class StrafeLeft : public Behavior
  {
     ...
     * @returns High confidence when the position is further to the left than it is to the front or back (\f$ y > |x|\f$)
     */
    virtual ConfidenceInterval getCapability(rf<State> s, rf<Goal> g);
  
  public:
    StrafeLeft(std::string const &id, std::string const &playerClass);
  };
};
