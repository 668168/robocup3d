...
#ifndef __INC_BATS_DISTRIBUTION3D_HH_
#define __INC_BATS_DISTRIBUTION3D_HH_
...
namespace bats {
   ...
   *
   * The Distribution class is an interface for distributions, mainly probability distributions, but can also be used for intentions.
   */
  class Distribution3D : public RefAble
  {
  public:
    Distribution3D() {}
     ...
     */
    virtual void predict(rf<Distribution3D> const &movementModel) = 0;
     ...
     */
    virtual void update(rf<Distribution3D> const &measurementModel) = 0;
  };
