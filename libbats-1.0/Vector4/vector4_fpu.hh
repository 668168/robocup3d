...
namespace bats {
  ...
  public:
    ...
    /** Constructor
     *
     * Initializes first three elements to values of \a other, the fourth to 1
     */
     ...
     *           have used a const array of 4 values.
     */
    inline operator float const * () const { return d_values; }

    /** Cast operator
     *
     * @returns A Vector3<float> with the values of the first three elements of this vector
     */
     ...
     *
     * \f$ \vec{V}_n = \frac{1}{|\vec{V}|} \vec{V} \f$
     */
    ...
    */
    ...
    /** Subtract another vector of this vector */
    inline Vector4F &operator-=(Vector4F const &other)
    {
    ...
    */
    ...
    /** Cechk whether all values of this vector are normal */
