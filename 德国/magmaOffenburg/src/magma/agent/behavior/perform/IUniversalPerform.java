...
public interface IUniversalPerform
{
	/**
	 ...
	 */
	public float getNextXSpeed(IAgentModel agentModel, IGlobalMap worldModel);

	public float getNextYSpeed(IAgentModel agentModel, IGlobalMap worldModel);
